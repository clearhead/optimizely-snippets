 ...
 * Usage
 *    This function will append an external JavaScript to the head of
 *    the document.
 *
 *  @param {String} location   - The location of the file you'd like
 *                               to load.
 *  @param {Function} callback - [OPTIONAL] A function to call when
 *                               the script has completed downloading.
 *
 */
